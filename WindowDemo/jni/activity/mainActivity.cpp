...
static ZKWindow* mNormalWindowPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ...
    ID_MAIN_Buttonnormal, onButtonClick_Buttonnormal,
    ID_MAIN_Buttonmode, onButtonClick_Buttonmode,
};
/***************/
...
void mainActivity::onCreate() {
    ...
    mQrcode1Ptr = (ZKQRCode*)findControlByID(ID_MAIN_Qrcode1);
    mTextview2Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview2);
    mNormalWindowPtr = (ZKWindow*)findControlByID(ID_MAIN_NormalWindow);
    mTextview1Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview1);
    mModeWindowPtr = (ZKWindow*)findControlByID(ID_MAIN_ModeWindow);
    mButtonnormalPtr = (ZKButton*)findControlByID(ID_MAIN_Buttonnormal);
    mButtonmodePtr = (ZKButton*)findControlByID(ID_MAIN_Buttonmode);
	onUI_init();
        // 注册监听全局触摸
