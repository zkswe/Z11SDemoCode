...
static ZKButton* mOpenSoftApButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_OpenSoftApButton, onButtonClick_OpenSoftApButton,
    ID_MAIN_OpenWifiButton, onButtonClick_OpenWifiButton,
};
/***************/
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mOpenSoftApButtonPtr = (ZKButton*)findControlByID(ID_MAIN_OpenSoftApButton);
    mOpenWifiButtonPtr = (ZKButton*)findControlByID(ID_MAIN_OpenWifiButton);
	onUI_init();
        // 注册监听全局触摸
