...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_SoundButton, onButtonClick_SoundButton,
};
/***************/
...
static S_ZKSeekBarCallback SZKSeekBarCallbackTab[] = {
    ID_MAIN_SoundSeekbar, onProgressChanged_SoundSeekbar,
};
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mSoundSeekbarPtr = (ZKSeekBar*)findControlByID(ID_MAIN_SoundSeekbar);if(mSoundSeekbarPtr!= NULL){mSoundSeekbarPtr->setSeekBarChangeListener(this);}
    mSoundButtonPtr = (ZKButton*)findControlByID(ID_MAIN_SoundButton);
