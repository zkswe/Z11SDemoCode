...
static ZKListView* mCycleListPtr;
...
static S_ListViewFunctionsCallback SListViewFunctionsCallbackTab[] = {
    ID_MAIN_CycleList, getListItemCount_CycleList, obtainListItemData_CycleList, onListItemClick_CycleList,
    ID_MAIN_List1, getListItemCount_List1, obtainListItemData_List1, onListItemClick_List1,
};
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mCycleListPtr = (ZKListView*)findControlByID(ID_MAIN_CycleList);if(mCycleListPtr!= NULL){mCycleListPtr->setListAdapter(this);mCycleListPtr->setItemClickListener(this);}
    mList1Ptr = (ZKListView*)findControlByID(ID_MAIN_List1);if(mList1Ptr!= NULL){mList1Ptr->setListAdapter(this);mList1Ptr->setItemClickListener(this);}
	onUI_init();
        // 注册监听全局触摸
