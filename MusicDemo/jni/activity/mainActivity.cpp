...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_StopButton, onButtonClick_StopButton,
    ID_MAIN_PauseButton, onButtonClick_PauseButton,
    ID_MAIN_PlayButton, onButtonClick_PlayButton,
};
/***************/
...
void mainActivity::onCreate() {
    ...
    mStopButtonPtr = (ZKButton*)findControlByID(ID_MAIN_StopButton);
    mPauseButtonPtr = (ZKButton*)findControlByID(ID_MAIN_PauseButton);
    mTextview1Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview1);
    mPlayButtonPtr = (ZKButton*)findControlByID(ID_MAIN_PlayButton);
	onUI_init();
        // 注册监听全局触摸
