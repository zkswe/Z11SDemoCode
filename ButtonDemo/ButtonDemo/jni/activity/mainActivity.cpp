...
static ZKButton* mLongButtonPtr;
static ZKButton* mClkButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_LongButton, onButtonClick_LongButton,
    ID_MAIN_ClkButton, onButtonClick_ClkButton,
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mLongButtonPtr = (ZKButton*)findControlByID(ID_MAIN_LongButton);
    mClkButtonPtr = (ZKButton*)findControlByID(ID_MAIN_ClkButton);
