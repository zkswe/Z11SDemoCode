...
static ZKDigitalClock* mDigitalclock10Ptr;
static ZKDigitalClock* mDigitalclock7Ptr;
static ZKDigitalClock* mDigitalclock4Ptr;
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mDigitalclock10Ptr = (ZKDigitalClock*)findControlByID(ID_MAIN_Digitalclock10);
    mDigitalclock7Ptr = (ZKDigitalClock*)findControlByID(ID_MAIN_Digitalclock7);
    mDigitalclock4Ptr = (ZKDigitalClock*)findControlByID(ID_MAIN_Digitalclock4);
