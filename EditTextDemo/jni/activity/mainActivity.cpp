...
static S_EditTextInputCallback SEditTextInputCallbackTab[] = {
    ID_MAIN_Edittextpass2, onEditTextChanged_Edittextpass2,
    ID_MAIN_Edittextpass1, onEditTextChanged_Edittextpass1,
    ID_MAIN_Edittextnu, onEditTextChanged_Edittextnu,
    ID_MAIN_EdittextAllInfo, onEditTextChanged_EdittextAllInfo,
};
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mEdittextpass2Ptr = (ZKEditText*)findControlByID(ID_MAIN_Edittextpass2);if(mEdittextpass2Ptr!= NULL){mEdittextpass2Ptr->setTextChangeListener(this);}
    mEdittextpass1Ptr = (ZKEditText*)findControlByID(ID_MAIN_Edittextpass1);if(mEdittextpass1Ptr!= NULL){mEdittextpass1Ptr->setTextChangeListener(this);}
    mEdittextnuPtr = (ZKEditText*)findControlByID(ID_MAIN_Edittextnu);if(mEdittextnuPtr!= NULL){mEdittextnuPtr->setTextChangeListener(this);}
    mTextview4Ptr = (ZKTextView*)findControlByID(ID_MAIN_Textview4);
    mEdittextAllInfoPtr = (ZKEditText*)findControlByID(ID_MAIN_EdittextAllInfo);if(mEdittextAllInfoPtr!= NULL){mEdittextAllInfoPtr->setTextChangeListener(this);}
